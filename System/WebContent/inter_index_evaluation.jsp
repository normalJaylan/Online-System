...
<body>
	...
	<div class="templatemo-container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 white-bg right-container">
            ...
            <div id="tlkio" data-channel="docter" style="width:820px;height:450px;border:1px solid black;margin-top:-50px;margin-left: 45px;"></div><!-- <script async src="http://tlk.io/embed.js" type="text/javascript"></script> -->
            <textarea id="input_about_evaluation"></textarea>
            <button class="fa fa-arrow-up submit_evaluation">提交报告</button>
		</div> <!-- right-->
	</div>
